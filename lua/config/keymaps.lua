...
map("n", "<leader>tp", ":terminal cd " .. root_path .. " && pwsh<CR>", { silent = true, desc = "Open Terminal (Root Dir)" })

-- Split terminal
map("n", "<leader>ts", ":belowright split | terminal<CR>", { silent = true, desc = "Terminal Horizontal Split (Below)" })
