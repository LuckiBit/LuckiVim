return {
    ...
    config = function(_, opts)
        ...
        wk.add({
            ...
            { "<leader>h", group = "hex/highlight", icon = { icon = "", color = "yellow" } },
            { "<leader>hh", desc = "Clear Search Highlight", icon = { icon = "󰛉", color = "yellow" } },
            { "<leader>ht", desc = "Toggle Hex Mode", icon = { icon = "󰘦", color = "orange" } },
            ...
            { "<leader>m", group = "mason/markdown", icon = { icon = "", color = "blue" } },
